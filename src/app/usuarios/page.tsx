...
export default function Page() {
  ...
  return (
    <div className="ml-5">
      <h1 className="text-bold text-black text-3xl">Usuarios</h1>
      <div className="breadcrumbs text-sm">
        <ul>
          <li>
            <a><Link href="/">Dashboard </Link></a> / <a className="text-bold text-black"> Usuario</a>
          </li>
      ...
      <button className="btn btn-outline btn-info font-bold ml-5">
        <Link href="/empleados/registrar">+ Nuevo Usuario</Link>
      </button>
