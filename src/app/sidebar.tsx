...
export default function Page() {
  return (
    <aside className="flex bg-blue flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-blue-700 dark:border-gray-700">
        ...
        <nav className="-mx-3 space-y-6 ">
          <div className="space-y-3 ">
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Usuario</span>
            </a>
            <a
              className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
              href="#"
            >
              ...
              <span className="mx-2 text-sm font-medium">Tipos de Usuarios</span>
            </a>
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Tandas</span>
            </a>
            <a
              className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
              href="#"
