    ...
    <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
      <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
        ...
        <tbody className="divide-y divide-gray-100 border-t border-gray-100">
          ...
          {/* Repite para los demás usuarios */}
          <tr className="hover:bg-gray-50">
            <td className="px-6 py-4">2</td>
            <td className="flex gap-3 px-6 py-4 font-normal text-gray-900">
              <div className="relative h-10 w-10">
              ...
              <div className="text-sm">
                <div className="font-medium text-gray-700">Jaiden Nixon</div>
                <div className="text-gray-400">jaiden.n@gmail.com</div>
              </div>
            </td>
            <td className="px-6 py-4">
              <span className="inline-flex items-center gap-1 rounded-full bg-green-50 px-2 py-1 text-xs font-semibold text-green-600">
            ...
            <td className="px-6 py-4">jaiden.n@gmail.com</td>
            <td className="px-6 py-4">09/30/1963</td>
            <td className="px-6 py-4">
              <div className="flex justify-end gap-4">
                <a x-data="{ tooltip: 'Delete' }" href="#">
                  <svg
