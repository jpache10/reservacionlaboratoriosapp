...
export default function Page() {
  ...
  return (
    <div className="ml-5">
      <h1 className="text-bold">Empleados</h1>
      <div className="breadcrumbs text-sm">
        <ul>
          <li>
            <a><Link href="/">Dashboard</Link></a>
          </li>
          <li className="text-bold">
            <a className="text-bold">Empleados</a>
          </li>
        </ul>
      </div>
      <button className="btn btn-outline btn-info font-bold ml-5">
        <Link href="/empleados/registrar">+ Registrar un empleado</Link>
      </button>
